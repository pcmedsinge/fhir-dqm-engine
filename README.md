...
**v0.1.0-alpha.1 — scaffolding complete, working on data ingest.**

Phase 1 scaffold is live: NestJS/TypeScript monorepo, `/health` endpoint, CI pipeline, Docker image. Phase 2 (FHIR data ingest) is next.
...
# {"status":"ok","info":{"service":{"status":"up"}},"version":"0.1.0-alpha.1",...}
```
